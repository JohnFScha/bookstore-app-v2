...
export default async function Home() {
  ...
  return (
    <section className='grid lg:grid-cols-4 md:grid-cols-3 xs:grid-cols-1 gap-5 p-5'>
      {books ? books.map((book: Book) => (
        <article key={book._id} className='flex flex-col gap-5 border-2 rounded-lg p-2'>
