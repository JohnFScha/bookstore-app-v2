...
export default function Header() {
  return (
    <header className='flex lg:flex-nowrap lg:justify-between md:justify-between md:p-3 xs:p-5 border-b-2 rounded-b-xl shadow-md shadow-white  xs:justify-center xs:gap-5'>
